...
type DiscoveryServiceClient interface {
	...
	GetComposition(ctx context.Context, in *GetDiscoveryRequest, opts ...grpc.CallOption) (*DiscoveriesResponse, error)
...
func (c *discoveryServiceClient) GetComposition(ctx context.Context, in *GetDiscoveryRequest, opts ...grpc.CallOption) (*DiscoveriesResponse, error) {
	out := new(DiscoveriesResponse)
	err := c.cc.Invoke(ctx, "/protos.DiscoveryService/GetComposition", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DiscoveryServiceServer interface {
	...
	GetComposition(context.Context, *GetDiscoveryRequest) (*DiscoveriesResponse, error)
...
func (UnimplementedDiscoveryServiceServer) GetComposition(context.Context, *GetDiscoveryRequest) (*DiscoveriesResponse, error) {
...
func _DiscoveryService_GetComposition_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetDiscoveryRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DiscoveryServiceServer).GetComposition(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/protos.DiscoveryService/GetComposition",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DiscoveryServiceServer).GetComposition(ctx, req.(*GetDiscoveryRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var DiscoveryService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _DiscoveryService_GetComposition_Handler,
		},
		{
